    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-3xl font-bold mb-4">About Lucent</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div
              className="relative h-fit rounded-xl overflow-hidden shadow-lg flex items-center justify-center"
            >
              <Image
                src="/logo.png"
                alt="ACME Store Team"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div
              className="relative h-fit rounded-xl overflow-hidden shadow-lg order-1 md:order-2 flex items-center justify-center"
            >
              <Image
                src="/logo.png"
